...
Revision ID: d5f8a1064c59
Revises: 
Create Date: 2024-11-13 12:26:10.271533
...
def upgrade():
    ...
    sa.Column('Status', sa.Enum('Read', 'Unread', name='status_enum'), nullable=True),
    sa.ForeignKeyConstraint(['UserID'], ['users.UserID'], ),
